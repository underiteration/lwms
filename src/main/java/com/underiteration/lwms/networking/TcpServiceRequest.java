...
public class TcpServiceRequest {
	...
	public synchronized static void sendAsyncRemoteServiceRequest(InetAddress address, Integer servicePort, String serviceName, String jobReference, Integer callbackPort, String payload) throws IOException {
	...
	public synchronized static void sendAsyncRemoteServiceResponse(InetAddress address, Integer servicePort, String jobReference, Boolean success, Integer backPressure, String payload) throws IOException {
		...
		out.write(DELIMIT);
		out.write(backPressure.toString().getBytes());
		out.write(DELIMIT);
		out.write(payload.getBytes());
		out.flush();
	...
	public synchronized static byte[] sendOptionsRequest(InetAddress address, Integer servicePort) throws IOException {
